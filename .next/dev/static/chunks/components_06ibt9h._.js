...
function CinematicHero() {
    ...
    const handleEnter = (e)=>{
        ...
        // Trigger festival splash confetti!
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: `${styles.ctaWrapper} ${showCTA ? styles.ctaProminent : ""}`,
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: styles.circularTextWrapper,
...
_s(CinematicHero, "URfVY8rJBSm4GehlCqJSU6aSTbw=");
_c = CinematicHero;
var _c;
...
;
;
// Custom shader for the liquid particle field
const vertexShader = `
  uniform float uTime;
  uniform vec2 uMouse;
  uniform int uScene;
  ...
  // Classic 3D noise function snippet could go here, 
  // but for performance, we'll use sine waves combined for organic flow
  
  void main() {
    vec3 pos = position;
    
    // Base organic wave using sine - reduced amplitude for subtlety
    float wave = sin(pos.x * 0.05 + uTime * 0.2) * cos(pos.y * 0.05 + uTime * 0.1) * 3.0;
    
    // Mouse repulsion
    vec2 mouseWorld = uMouse * 100.0; // Scale approx to world size
    float distToMouse = distance(pos.xy, mouseWorld);
    float repulsion = 0.0;
    if(distToMouse < 40.0) {
      repulsion = (40.0 - distToMouse) * 0.2; // Softer repulsion
    }
    
    // Scene-specific behavior (all made much more subtle)
    if (uScene == 0) {
      // Normal slow wave
    } else if (uScene == 1) {
      // Ripple (More attention)
      float ripple = sin(distToMouse * 0.3 - uTime * 3.0) * 2.0;
      wave += ripple * smoothstep(50.0, 0.0, distToMouse);
    } else if (uScene == 2) {
      // Expand (More impact)
      pos.xy *= 1.0 + sin(uTime * 0.5) * 0.05;
    } else if (uScene == 3) {
      // Fast wave (More connection)
      wave = sin(pos.x * 0.1 + uTime * 0.5) * cos(pos.y * 0.1 + uTime * 0.5) * 6.0;
    } else if (uScene == 4) {
      // Converge (More growth)
      vec2 center = vec2(0.0);
      float dist = distance(pos.xy, center);
      pos.xy -= normalize(pos.xy) * sin(uTime * 0.5) * min(dist, 3.0);
    } else if (uScene >= 9) {
      // Organize and converge softly
      vec2 center = vec2(0.0);
      pos.xy = mix(pos.xy, center, 0.05); 
    }
    
    pos.z += wave + repulsion;
    
    // Final liquid transition distortion
    if (uTransition > 0.0) {
      // Pull to center then explode
      vec2 center = vec2(0.0);
      ...
      if (uTransition < 0.5) {
        ...
        pos.xy = mix(pos.xy, center, pull * 0.8);
      } else {
        // Phase 2: Explode outward and ripple Z
        float exp = smoothstep(0.5, 1.0, uTransition);
        pos.xy += normalize(pos.xy) * exp * 150.0;
        pos.z += sin(distToCenter * 0.2 - uTime * 10.0) * exp * 50.0;
      }
    }
    ...
    // Fade alpha based on Z depth
    vAlpha = smoothstep(-20.0, 20.0, pos.z) * 0.5 + 0.2;
    
    // Transition fade out
    if (uTransition > 0.5) {
      vAlpha *= 1.0 - smoothstep(0.5, 1.0, uTransition);
    }
...
const fragmentShader = `
  ...
  void main() {
    ...
    // Almost white with a tiny tint (subtle opacity)
    gl_FragColor = vec4(1.0, 0.95, 0.9, a * 0.4);
  }
`;
function Particles({ sceneIndex, transitionProgress, mousePos }) {
    _s();
    const { size, viewport } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$156d8d12$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__C__as__useThree$3e$__["useThree"])();
    ...
    const particleCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Particles.useMemo[particleCount]": ()=>{
    ...
    const [positions, sizes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Particles.useMemo": ()=>{
            ...
            // Scatter particles across a wide plane
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$156d8d12$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__useFrame$3e$__["useFrame"])({
        "Particles.useFrame": (state)=>{
            if (materialRef.current) {
                ...
                // Target mouse position smoothly
                const currentMouse = materialRef.current.uniforms.uMouse.value;
                currentMouse.x += (mousePos.current[0] - currentMouse.x) * 0.1;
                currentMouse.y += (mousePos.current[1] - currentMouse.y) * 0.1;
                materialRef.current.uniforms.uScene.value = sceneIndex;
...
_s(Particles, "d1x2fmUJ3kPYFy2zbOBpWat91sw=", false, function() {
    return [
...
_c = Particles;
function ParticleField({ sceneIndex, transitionProgress }) {
    _s1();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ParticleField.useEffect": ()=>{
            ...
            return ({
                "ParticleField.useEffect": ()=>window.removeEventListener('mousemove', handleMouseMove)
            })["ParticleField.useEffect"];
        }
    }["ParticleField.useEffect"], []);
...
_s1(ParticleField, "+isgxKiZMnB/Qyasr4yFpBHmFGg=");
_c1 = ParticleField;
var _c, _c1;
...
//# sourceMappingURL=components_06ibt9h._.js.map