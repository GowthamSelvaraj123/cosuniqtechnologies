    ...
    <section className={`${styles.serviceSection} ${styles.bgWhite}`} id="brand">
      <div className={styles.container}>
        <div className={`${styles.serviceSectionInner} ${styles.reverse}`}>
          ...
          <div className={styles.serviceVisual}><img src="/assets/services/brand_story.jpg" alt="Service Story" style={{ width: '100%', height: 'auto', borderRadius: '16px', mixBlendMode: 'multiply' }} /></div>
        </div>
      </div>
    </section>
  );
    ...
    <section className={`${styles.serviceSection} ${styles.bgLightOrange}`} id="web-dev">
      <div className={styles.container}>
        <div className={`${styles.serviceSectionInner} ${styles.reverse}`}>
          ...
          <div className={styles.serviceVisual}><img src="/assets/services/design_story.jpg" alt="Service Story" style={{ width: '100%', height: 'auto', borderRadius: '16px', mixBlendMode: 'multiply' }} /></div>
        </div>
      </div>
    </section>
  );
    ...
    <section className={`${styles.serviceSection} ${styles.bgDarkOrange}`} id="design">
      <div className={styles.container}>
        <div className={`${styles.serviceSectionInner}`}>
          ...
          <div className={styles.serviceVisual}><img src="/assets/services/webdev_story.jpg" alt="Service Story" style={{ width: '100%', height: 'auto', borderRadius: '16px', mixBlendMode: 'multiply' }} /></div>
        </div>
      </div>
    </section>
  );
    ...
    <section className={`${styles.serviceSection} ${styles.bgDarkOrange}`} id="ecommerce">
      <div className={styles.container}>
        <div className={`${styles.serviceSectionInner} ${styles.reverse}`}>
          ...
          <div className={styles.serviceVisual}><img src="/assets/services/mobile_story.jpg" alt="Service Story" style={{ width: '100%', height: 'auto', borderRadius: '16px', mixBlendMode: 'multiply' }} /></div>
        </div>
      </div>
    </section>
  );
    ...
    <section className={`${styles.serviceSection} ${styles.bgLightOrange}`} id="software">
      <div className={styles.container}>
        <div className={styles.serviceSectionInner}>
          ...
          <div className={styles.serviceVisual}><img src="/assets/services/ecommerce_story.jpg" alt="Service Story" style={{ width: '100%', height: 'auto', borderRadius: '16px', mixBlendMode: 'multiply' }} /></div>
        </div>
      </div>
    </section>
  );
    ...
    <section className={`${styles.serviceSection} ${styles.bgWhite}`} id="mobile">
      <div className={styles.container}>
        <div className={styles.serviceSectionInner}>
          ...
          <div className={styles.serviceVisual}><img src="/assets/services/software_story.jpg" alt="Service Story" style={{ width: '100%', height: 'auto', borderRadius: '16px', mixBlendMode: 'multiply' }} /></div>
        </div>
      </div>
    </section>
  );
    ...
    <section className={`${styles.serviceSection} ${styles.bgWhite}`} id="cloud">
      <div className={styles.container}>
        <div className={`${styles.serviceSectionInner} ${styles.reverse}`}>
          ...
          <div className={styles.serviceVisual}><img src="/assets/services/cloud_story.jpg" alt="Service Story" style={{ width: '100%', height: 'auto', borderRadius: '16px', mixBlendMode: 'multiply' }} /></div>
        </div>
      </div>
    </section>
  );
