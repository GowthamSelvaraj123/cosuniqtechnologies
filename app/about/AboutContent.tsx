    ...
    <div className={styles.pageWrapper}>
      ...
      <section className={`${styles.storySection} ${styles.sectionPadding}`} ref={storyRef}>
        <div className={styles.floatingIconContainer}>
          {[
            // 1. Stone Tool (Top Left Corner)
            { path: "M14.5 2 2 14.5l3.5 3.5 12.5-12.5L14.5 2zM6 18c-2 2-4 2-4 2s0-2 2-4", size: 28, top: "10%", left: "5%", color: "#888", opacity: 0.35, delay: 0 },
            // 2. Fire (Below Stone Tool)
            { path: "M8.5 14.5A2.5 2.5 0 0011 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 11-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 002.5 2.5z", size: 32, top: "25%", left: "10%", color: "#888", opacity: 0.4, delay: 0.2 },
            // 3. Writing (High Left)
            { path: "M12 19l7-7 3 3-7 7-3-3z M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z M2 2l7.586 7.586 M11 11l1 1", size: 28, top: "5%", left: "15%", color: "#888", opacity: 0.45, delay: 0.4 },
            // 4. Wheel (Mid Left, Above Title)
            { path: "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M12 14a2 2 0 100-4 2 2 0 000 4z M12 2v8 M12 14v8 M4.93 4.93l5.66 5.66 M13.41 13.41l5.66 5.66 M2 12h8 M14 12h8 M4.93 19.07l5.66-5.66 M13.41 10.59l5.66-5.66", size: 40, top: "18%", left: "22%", color: "#888", opacity: 0.5, delay: 0.6 },
            // 5. Gear (High Left-Center)
            { path: "M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-2 2 2 2 0 01-2-2v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83 0 2 2 0 010-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H3a2 2 0 01-2-2 2 2 0 012-2h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 010-2.83 2 2 0 012.83 0l.06.06a1.65 1.65 0 001.82.33H9a1.65 1.65 0 001-1.51V3a2 2 0 012-2 2 2 0 012 2v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 0 2 2 0 010 2.83l-.06.06a1.65 1.65 0 00-.33 1.82V9a1.65 1.65 0 001.51 1H21a2 2 0 012 2 2 2 0 01-2 2h-.09a1.65 1.65 0 00-1.51 1z M12 15a3 3 0 100-6 3 3 0 000 6z", size: 36, top: "8%", left: "32%", color: "#999", opacity: 0.55, delay: 0.8 },
            // 6. Electricity (Mid Center, Above Title)
            { path: "M13 2L3 14h9l-1 8 10-12h-9l1-8z", size: 32, top: "28%", left: "35%", color: "#999", opacity: 0.6, delay: 1.0 },
            // 7. Computer (Center)
